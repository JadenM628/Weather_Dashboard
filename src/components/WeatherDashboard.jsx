      ...
      {error ? (
        ...
        <section className="weather_info">
          ...
          <div className="weather_summary_container">
            <img
              src={`/Weather_Dashboard/assets/icons/${getWeatherIcon(weatherData.weather[0].id)}`}
            ...
            {forecastData.map((item, idx) => {
              ...
              return (
                <div className="forecast_item" key={idx}>
                  ...
                  <img src={`/Weather_Dashboard/assets/icons/${getWeatherIcon(item.weather[0].id)}`} className="forecast-item-img" alt="Forecast Icon" />
